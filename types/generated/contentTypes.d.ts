...
export interface ApiStrategyProductStrategyProduct
  extends Schema.CollectionType {
  collectionName: 'strategy_products';
  info: {
    singularName: 'strategy-product';
    pluralName: 'strategy-products';
    displayName: 'StrategyProduct';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::strategy-product.strategy-product',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    paidProductIds: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::strategy-product.strategy-product': ApiStrategyProductStrategyProduct;
